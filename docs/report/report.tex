...
% Запрет разрыва страницы после строки, оканчивающейся переносом слова.
\brokenpenalty=10000
% Более свободное размещение плавающих объектов: меньше разреженных страниц.
\renewcommand{\topfraction}{.85}\renewcommand{\bottomfraction}{.7}
\renewcommand{\textfraction}{.1}\renewcommand{\floatpagefraction}{.75}
